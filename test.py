"""
IDRIS TEST SCRIPT - General and Realtime Chat Selector
========================================================
PURPOSE:
This is a command-line test interface for interacting with I.D.R.I.S.
...
WHY IT EXISTS:
- Provides an easy way to test the IDRIS API without building a frontend
...
def print_header():
    print("\n" + "="*60)
    print("🤖 I.D.R.I.S - General & Realtime Chat")
    print("="*60)
    print("\nModes:")
...
def send_message(message, mode):
    """
    Send a message to the appropriate IDRIS endpoint.
    ...
    Returns:
        str: IDRIS's response, or an error message if something went wrong
...
def get_chat_history():
    ...
    Note:
        ...
        - Messages are numbered and clearly labeled as "You" or "IDRIS"
    """
    if not SESSION_ID:
