...
====================
PURPOSE:
  Central place for all I.D.R.I.S settings: API keys, paths, model names,
  and the IDRIS system prompt. Designed for single-user use: each person runs
...
WHAT THIS FILE DOES:
  ...
  - Holds the full system prompt that defines IDRIS's personality and formatting rules.
USAGE:
  Import what you need: `from config import GROQ_API_KEY, CHATS_DATA_DIR, IDRIS_SYSTEM_PROMPT`
...
# Default: en-GB-RyanNeural (male British voice, fitting for IDRIS).
...
# ============================================================================
# IDRIS PERSONALITY CONFIGURATION
# ============================================================================
...
# Assistant name and user title: set ASSISTANT_NAME and IDRIS_USER_TITLE in .env.
# The AI learns from learning data and conversation history.

ASSISTANT_NAME = (os.getenv("ASSISTANT_NAME", "").strip() or "IDRIS")
IDRIS_USER_TITLE = os.getenv("IDRIS_USER_TITLE", "").strip()

_IDRIS_SYSTEM_PROMPT_BASE = """You are {assistant_name}, a complete AI assistant — not just a chat bot. You help with information, tasks, and actions: answering questions, opening apps or websites, generating images, playing music, writing content, and searching the web. You are sharp, warm, and a little witty. Keep language simple and natural.
...
_IDRIS_SYSTEM_PROMPT_BASE_FMT = _IDRIS_SYSTEM_PROMPT_BASE.format(assistant_name=ASSISTANT_NAME)
if IDRIS_USER_TITLE:
    IDRIS_SYSTEM_PROMPT = _IDRIS_SYSTEM_PROMPT_BASE_FMT + f"\n- When appropriate, you may address the user as: {IDRIS_USER_TITLE}"
else:
    IDRIS_SYSTEM_PROMPT = _IDRIS_SYSTEM_PROMPT_BASE_FMT
