...
def print_title():
    """Print the I.D.R.I.S ASCII art title."""
    title = """
   ╔══════════════════════════════════════════════════════════╗
   ║                                                          ║
   ║     ██╗██████╗ ██████╗ ██╗███████╗                       ║
   ...
   ║     ╚═╝╚═════╝ ╚═╝  ╚═╝╚═╝╚══════╝                       ║
   ║                                                          ║
   ║     Integrated On Device Revised Intelligent System      ║
   ║                                                          ║
   ╚══════════════════════════════════════════════════════════╝
    """
...
async def lifespan(app: FastAPI):
    ...
    print_title()
    logger.info("=" * 60)
    logger.info("I.D.R.I.S - Starting Up ... ")
    logger.info("=" * 60)
    ...
    try:
        ...
        logger.info("=" * 60)
        logger.info("I.D.R.I.S is online and ready!")
